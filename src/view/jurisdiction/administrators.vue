  ...
  <div class="hesrder">
    ...
    <div>
      <el-table :data="tableData.arr" border @selection-change="handleSelectionChange" style="width: 100%">
        ...
        <el-table-column prop="admin_name" label="管理员名称" width="168" align='center'/>
        <el-table-column prop="name" label="部门" width="168" align='center'/>
        <el-table-column prop="real_name" label="真实姓名" width="168" align='center'/>
        <el-table-column prop="mobile" label="手机号" width="168" align='center'/>
        <el-table-column prop="email" label="邮箱" width="168" align='center'/>
        <el-table-column prop="roles" label="角色" width="168" align='center'/>   
        <el-table-column prop="remarks" label="备注" width="168" align='center'/>
        <el-table-column  label="是否启用" width="168" align='center'>
...
import {adminList} from '../../api/dynamic'
...
const getreviewer =async () =>{
  ...
  let res:any =await adminList(data)
  console.log(res);
