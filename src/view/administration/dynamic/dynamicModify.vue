...
import {newsEdit} from '../.././../api/dynamic'
...
const table = JSON.parse(route.query.data)
console.log(table);
// 取token
...
const handleAvatarSuccess: UploadProps['onSuccess'] = (
  ...
  thumb.value = URL.createObjectURL(uploadFile.raw!)
...
const determine = async() =>{
  let data ={
    ...
    formdata:{
        ...
        thumb: ruleForm.thumb, 
        author: ruleForm.author
    }
  }
  let res =await newsEdit(data)
  console.log(res);
  router.push('/dynamic')
}
</script>
